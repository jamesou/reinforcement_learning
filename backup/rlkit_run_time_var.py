...
if __name__ == '__main__':
    if debug:
        ...
        for c in tuples:
            ...
            # if run_config['patient_name'] not in ["adolescent#001",'child#001','child#002','child#003','child#004','child#005','child#006','child#007']:
            ...
            if run_config['patient_name'] in ['adult#001']:
                for time_std_1 in [0.1,1,10]:
                    ...
                    run_func(run_config)
            # if run_config['patient_name'] in ['adolescent#006','adult#006']:
            #     run_func(run_config)
