...
# action_scale = 'basal'    #'basal' 适用于连续的SAC
action_scale = 1    # 1 适用于离散型的DQN
basal_scaling = 43.2
action_bias = 0
...
if __name__ == '__main__':
    ...
    # elif device_list is not None:
        ...
        for c in tuples:
            ...
            # if run_config['patient_name'] not in ["adolescent#001",'child#001','child#002','child#003','child#004','child#005']:
            if run_config['patient_name'] not in ["adolescent#001",'child#001','child#002','child#003','child#004','child#005','child#006','child#007','child#008','child#009']:
            # if run_config['patient_name'] in ["adolescent#001"]:
                run_func(run_config)
