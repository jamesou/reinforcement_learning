...
from bgp.rl.rlkit_platform import run_em_sac, finish_sac, simulate_policy
...
if __name__ == '__main__':
    if debug:
        ...
        for c in tuples:
            ...
            # if run_config['patient_name'] in ['child#008','adolescent#008','adult#008']:
            if run_config['patient_name'] in ['adult#001']:
                variant=run_config
                for time_std_1 in [0.1,1,10]:
                    run_config["time_std"]=time_std_1
                    run_config["log_dir"]=run_config["log_dir"]+";"+str(time_std_1)
                    run_func(run_config)
